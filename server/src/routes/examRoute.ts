...
const validateExam = (req: express.Request, res: express.Response, next: express.NextFunction) => {
...
examRouter.put('/exam/:examId', async (req, res) => {
    ...
    try {
      const exam = await Exam.findByIdAndUpdate(examId, updatedExamData, { new: true });
