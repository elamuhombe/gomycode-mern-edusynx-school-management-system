    ...
    <div className="bg-gray-200">
      ...
      <div className="flex">
        ...
        <div className="flex flex-wrap justify-center ml-40">
          <Card title="New Applications" description="View and process new student applications." />
          <Card title="Enrolled Students" description="Manage enrolled student records." />
          <Card title="Admissions" description="Handle admissions processes and documentation." />
          <Card title="Reports" description="Generate enrollment-related reports." />
        </div>
      </div>
    </div>
  );
